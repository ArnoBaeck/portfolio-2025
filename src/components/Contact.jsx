		...
		<div className="contact-container">
			...
			<div className="contact-content">
				<div className="content-text">
					<p>
						I am a third-year Multimedia & Creative Technologies student with a passion for full-stack development and
						design, aiming to create projects that are both functional and visually engaging
					</p>
				</div>
